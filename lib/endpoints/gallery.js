...
var Gallery = function(imgur) {
    ...
    this.memeImage = function(params) {
        ...
        return imgur.request('get', 'g/memes/{id}', options);
    };
    ...
    this.publish = function(params) {
        ...
        if (!params.hasOwnProperty('title')) {
            throw new Erorr('title required');
        }
        var options = imgur.extend(params, {
            id: params.id,
            data: {
    ...
    this.comment = function(params) {
        ...
        return imgur.request('get', 'gallery/{id}/comment/{comment_id}', options);
    };
    ...
    this.createCommentReply = function(params) {
        ...
        return imgur.request('post', 'gallery/{id}/comment/{comment_id}', options);
    };
